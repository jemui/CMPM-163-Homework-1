...
Shader "Custom/Phong"
{
    Properties
    {   
        _Color ("Color", Color) = (1, 1, 1, 0) //The color of our object
        _Shininess ("Shininess", Float) = 50 //Shininess
        _SpecColor ("Specular Color", Color) = (1, 1, 1, 0) //Specular highlights color
    ...
    {
        Pass {
            Tags { "LightMode" = "ForwardAdd" "RenderType"="Opaque"} //Important! In Unity, point lights are calculated in the the ForwardAdd pass
           ...
           fixed4 frag(v2f i) : SV_Target
           {
                ...
                return col * float4(ambient + diffuse + specular, 1);
